        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          <Paper className={classes.paper}>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                <InputLabel id="demo-simple-select-label">Disable</InputLabel>
                <Select
            ...
            <table className="table align-middle mb-0 bg-white">
              ...
              <tbody>
                ...
                {data && data.filter((item) => item.title.includes(searchTerm) && item.isDisabled==isDisabled)
                  ...
                  .map((item, index) => (
                    ...
                    <tr key={index}>
                      ...
                      <td>{item.title}</td>
                      <td>{item.State}</td>
                      <td>{item.property_history?(limitText(item.property_history)):""}</td>
                      <td>{item.description?limitText(item.description):""}</td>
                      <td>{item.Emd}</td>
